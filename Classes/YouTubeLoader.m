...
+ (void)init :(NSString *)videoID {
    ...
    if (isLive == true && [playabilityStatus isEqual:@"OK"]) {
        ...
        if (isLocatedInEU == 1) {
            ...
            NSMutableDictionary *youtubeTVOSEmbedPlayerRequest = [YouTubeExtractor youtubeTVOSEmbedPlayerRequest:videoID];
            NSDictionary *innertubeFormats = youtubeTVOSEmbedPlayerRequest[@"streamingData"][@"formats"];
            NSURL *video2160p;
            NSURL *video1440p;
            NSURL *video1080p;
            NSURL *video720p;
