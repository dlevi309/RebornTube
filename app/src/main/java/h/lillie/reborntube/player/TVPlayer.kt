                ...
                for (i in 0 until jsonArray.length()) {
                    ...
                    if (category.contains("sponsor") && player.currentPosition >= segment0 && player.currentPosition <= (segment1 - 1)) {
                        ...
                        if (selfpromoBlockSelfpromo == 1) {
                            player.seekTo(segment1.toLong())
                            Toast.makeText(this@TVPlayer, "Selfpromo Skipped", Toast.LENGTH_SHORT).show()
                        }
                        ...
                        if (introBlockIntro == 1) {
                            player.seekTo(segment1.toLong())
                            Toast.makeText(this@TVPlayer, "Intro Skipped", Toast.LENGTH_SHORT).show()
                        }
                        ...
                        if (outroBlockOutro == 1) {
                            player.seekTo(segment1.toLong())
                            Toast.makeText(this@TVPlayer, "Outro Skipped", Toast.LENGTH_SHORT).show()
                        }
                        ...
                        if (musicofftopicBlockMusicofftopic == 1) {
                            player.seekTo(segment1.toLong())
                            Toast.makeText(this@TVPlayer, "Music_offtopic Skipped", Toast.LENGTH_SHORT).show()
                        }
                    }
                }
            } catch (e: IOException) {
